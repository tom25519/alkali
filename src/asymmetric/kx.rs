...
pub mod x25519blake2b {
    ...
    hardened_buffer! {
        ...
        /// are [clamped](https://www.jcraige.com/an-explainer-on-ed25519-clamping) at time of
        /// usage, not when generated, so a private key can just be any random sequence of bytes.
        /// However, private keys should be indistinguishable from random noise, and should really
        /// be generated randomly using [`Keypair::generate`]. If you need to derive a private key
        /// deterministically, use [`Keypair::from_seed`].
        ///
